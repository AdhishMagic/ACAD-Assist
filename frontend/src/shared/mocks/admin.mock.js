...
export const setMockUsers = (updater) => {
  mockUsers = typeof updater === "function" ? updater(mockUsers) : updater;
};

export const setMockRoles = (updater) => {
  mockRoles = typeof updater === "function" ? updater(mockRoles) : updater;
};

export const setMockFiles = (updater) => {
  mockFiles = typeof updater === "function" ? updater(mockFiles) : updater;
};
